...
We will also remove the first 7 columns as they are not relevant for prediction purposes.
...
Based on our results we elect to use the random forest model.
...
Looks like our model did not overfit and should be effective to make the necessary 20 predictions.
